...
export default function Home() {
  return (
    <>
      ...
      {/* <div className="nav">
          <div className="nav-bar bg-white p-2 flex justify-between items-center rounded-lg shadow-lg mt-0.1 lg:mt-1  md:ml-24 lg:w-2/3">
          ...
          <div className="w-text">
            ...
            <p className="text-xs">
              Reserve your spot on our wait list for exclusive access to Raha
              Pay.
              <br />
              Join us and reap benefits
            </p>
